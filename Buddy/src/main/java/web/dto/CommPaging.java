...
public class CommPaging {
	...
	public CommPaging(int totalCount, int curPage) {
	...
	public CommPaging(int totalCount) {
		setTotalCount(totalCount);

		makePaging();
	}
	
	public CommPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public CommPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
	...
	public CommPaging(int curPage, int totalCount, int listCount, int totalPage, int pageCount, int startPage,
	...
	public String toString() {
		return "CommPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
