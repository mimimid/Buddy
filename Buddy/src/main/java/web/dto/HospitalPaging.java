...
public class HospitalPaging {
	...
	private void makePaging() {
		...
		if(listCount == 0)	this.listCount = 6; //화면에 보여질 게시글 수를 10개로 설정
	...
	public HospitalPaging(int curPage, int totalCount, int listCount, int totalPage, int pageCount, int startPage,
			int endPage, int startNo, int endNo, String hour24, String searchType, String keyWord) {
		super();
	...
	public String toString() {
		return "HospitalPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
				+ ", totalPage=" + totalPage + ", pageCount=" + pageCount + ", startPage=" + startPage + ", endPage="
				+ endPage + ", startNo=" + startNo + ", endNo=" + endNo + ", hour24=" + hour24 + ", searchType="
