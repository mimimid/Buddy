...
<div  class="clearfix" style="margin-bottom: 20px;">
	...
	<h3 style="margin-bottom: 20px;">입양프로필 작성</h3>
	...
	<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
	<a href="/adopt/proWrite" style="text-decoration: none; color: black;">
			입양프로필 작성</a>
	</div>
</div>
<form id="frm" action="/adopt/proWrite" method="post" enctype="multipart/form-data" onsubmit ="return event_click()" >
<div class = "row">
	<div class="col-md-4">
		<div id="img_wrap" >
			<img src="#" alt="입양프로필" id="View" class="img_style" style="visibility: hidden;">
		</div>
...
<script type="text/javascript">
	...
	<div class="col-md-8" style="padding: 10px 0px 0px 60px;">
		...
		<div class="form-group">
		   ...
		   <div class="col-sm-10">
			<select class="form-control" name="aniCate">
			  <option value="임보 중" selected>임보 중</option>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			<input type="text" id="aniName" name="aniName" class="form-control">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
			<input type="text" id="aniAge" name="aniAge" class="form-control" onkeyPress="javascript:checkInputNum();">
			</div>
		</div>
		<div class="form-group" id="gender">
			...
			<div class="radio">
				<label>
				<input type="radio" name="aniGender" id="aniGenderF" value="남자"> 남자
				</label>
			</div>
			<div class="radio" style="margin-left: 20px;">
				<label>
				<input type="radio" name="aniGender" id="aniGenderM" value="여자"> 여자
				</label>
			</div>
			</div>
			</div>
		...
		<div class="form-group" id="neutral">
			...
			<div class="radio">
				<label>
				<input type="radio" name="aniNeutral" id="aniNeutralY" value="한"> 네
				</label>
			</div>
			<div class="radio" style="margin-left: 20px;">
				<label>
				<input type="radio" name="aniNeutral" id="aniNeutralN" value="하지 않은"> 아니요
				</label>
			</div>
			</div>
			</div>
		...
		<div class="form-group">
			...
			<span class="glyphicon glyphicon-apple icons" aria-hidden="true"></span> 몸무게
			 ...
			 <div class="col-sm-10">
			<input type="text" id="aniWeight" name="aniWeight" class="form-control" onkeyPress="javascript:checkInputNum();">
			</div>
		</div>
		</div><!-- .form-horizontal -->
	</div>
...
<div class="form-group">
	...
	<textarea rows="10" style="width: 100%;" id="aniContent" name="aniContent"></textarea>
</div>
